...
class HedgeBot:
    ...
    async def _get_best_prices(self) -> Tuple[Decimal, Decimal]:
        ...
        return await self.fetch_grvt_bbo_prices()
    ...
    def handle_grvt_order_update(self, order_data):
        ...
        prev_position = Decimal(order_data.get('prev_position', str(self.grvt_position)))
        ...
        def order_update_handler(order_data):
            ...
            try:
                ...
                if status == 'FILLED' and self.grvt_order_status != 'FILLED':
                    prev_position_snapshot = self.grvt_position
                    if side == 'buy':
