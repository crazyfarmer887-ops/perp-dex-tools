...
class HedgeBot:
    ...
    async def _get_best_prices(self) -> Tuple[Decimal, Decimal]:
        ...
        return await self.fetch_backpack_bbo_prices()
    ...
    def handle_backpack_order_update(self, order_data):
        ...
        prev_position = Decimal(order_data.get('prev_position', str(self.backpack_position)))
        ...
        def order_update_handler(order_data):
            ...
            try:
                ...
                if status == 'FILLED' and self.backpack_order_status != 'FILLED':
                    prev_position_snapshot = self.backpack_position
                    if side == 'buy':
