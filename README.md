...
- `GRVT_BINGX_GAP_THRESHOLD`: 自定义 GRVT/BingX 中间价差门槛（价格单位），若未设置则默认使用 BingX tick
...
- `BINGX_SIMULTANEOUS_LIMIT`: （可选）设置为 1 时，在 GRVT 下 maker 单的同时就向 BingX 提交对冲限价单；设置为 0 则禁用
